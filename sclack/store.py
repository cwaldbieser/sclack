...
class Store:
    ...
    def get_user_display_name(self, user_detail):
        ...
        return (
            user_detail.get("display_name")
            or user_detail.get("real_name")
            or user_detail["name"]
        )
    ...
    def get_channel_info(self, channel_id):
        ...
        if channel_id[0] in ("C", "G"):
            ...
            result = self.slack.api_call("conversations.info", channel=channel_id)
    ...
    def load_channels(self):
        ...
        for channel in conversations:
            ...
            # Private channel
                ...
                self.state.channels.append(channel)
            # Direct message
            elif channel.get("is_im", False) and not channel.get(
    ...
    def load_groups(self):
        self.state.groups = filter(
            lambda c: c["is_group"] is True, self.slack.api_call("conversations.list")
        )
